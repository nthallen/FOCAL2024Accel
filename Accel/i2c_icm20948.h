...
#define I2C_ICM_FIFO_SAMPLES 2000
...
#define I2C_ICM_FIFO_DIAG_OFFSET I2C_ICM_FIFO_OFFSET+3
...
#define ICM_FS_8G  2
#define ICM_FS_16G 3
#define ICM_MODE0_SMPLRT_DIV 0x0
#define ICM_MODE1_SMPLRT_DIV 0x0
// DIV was 0 for max rate. 0x37 yields about 20 Hz
#define ICM_MODE2_SMPLRT_DIV 0x37
#define ICM_MODE0_ACCEL_CFG 0x01
//#define ICM_MODE1_ACCEL_CFG 0x01
#define ICM_MODE1_ACCEL_CFG 0x11
#define ICM_MODE2_ACCEL_CFG 0x39 // FCHOICE=1 DLPFCFG=7 3DB BW=473Hz ~1
//#define ICM_MODE2_ACCEL_CFG 0x01 // FCHOICE=1 DLPFCFG=0 3DB BW=246Hz ~0.14
//#define ICM_MODE2_ACCEL_CFG 0x11 // FCHOICE=1 DLPFCFG=2 3DB BW=111.4Hz: seriously attenuated ~.07
//#define ICM_MODE2_ACCEL_CFG 0x21 // FCHOICE=1 DLPFCFG=4 3DB BW=23.9Hz: seriously attenuated ~.018
